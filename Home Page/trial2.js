...
async function fetchData() {
  try {
    ...
    data.forEach(item => {
      ...
      chowmine_count = item.Chowmine;
      coffee_count = item.Coffee;
      cone_count = item.Cone;
      creamBar_count = item.icecreambar;
      Tea_count = item.Tea;
    ...
    if (count > 0) {
      ...
      if (AlooParatha_count != 0) {
        ...
        const div1Item1 = document.createElement("div");
        ...
        const div1Qty1 = document.createElement("div");
        div1Qty1.style.cssText = "font-size: 20px; font-weight : 200px ; font- family: cursive ; border:none;background : transparent; text-align: center";
        const div1QtyText = document.createTextNode(`${AlooParatha_count}`);
        div1.appendChild(div1Qty1);
        div1Qty1.appendChild(div1QtyText);


        const div1Price1 = document.createElement("div");
      ...
      if (maggi_count != 0) {
        ...
        const div2Item2 = document.createElement("div");
        ...
        const div2Qty2 = document.createElement("div");
        div2Qty2.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive ; border: none;background : transparent";
        const div2QtyText = document.createTextNode(`${(maggi_count)}`);
        div2.appendChild(div2Qty2);
        div2Qty2.appendChild(div2QtyText);

        const div2Price2 = document.createElement("div");
      ...
      if (chowmine_count != 0) {
        ...
        const div3Item3 = document.createElement("div");
        ...
        const div3Qty3 = document.createElement("div");
        div3Qty3.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive ; border: none;background : transparent";
        const div3QtyText = document.createTextNode(`${chowmine_count}`);
        div3.appendChild(div3Qty3);
        div3Qty3.appendChild(div3QtyText);

        const div3Price3 = document.createElement("div");
      ...
      if (vegroll_count != 0) {
        ...
        const div4Item4 = document.createElement("div");
        ...
        const div4Qty4 = document.createElement("div");
        div4Qty4.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive ; border: none;background : transparent";
        const div4QtyText = document.createTextNode(`${vegroll_count}`);
        div4.appendChild(div4Qty4);
        div4Qty4.appendChild(div4QtyText);

        const div4Price4 = document.createElement("div");
      ...
      if (Tea_count != 0) {
        ...
        const div5Item5 = document.createElement("div");
        ...
        const div5Qty5 = document.createElement("div");
        div5Qty5.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive  ; border: none;background : transparent";
        const div5Qty5Text = document.createTextNode(`${Tea_count}`);
        div5.appendChild(div5Qty5);
        div5Qty5.appendChild(div5Qty5Text);

        const div5Price5 = document.createElement("div");
      ...
      if (coffee_count != 0) {
        ...
        const div6Item6 = document.createElement("div");
        ...
        const div6Qty6 = document.createElement("div");
        div6Qty6.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive ; border: none;background : transparent";
        const div6Qty6Text = document.createTextNode(`${coffee_count}`);
        div6.appendChild(div6Qty6);
        div6Qty6.appendChild(div6Qty6Text);

        const div6Price6 = document.createElement("div");
      ...
      if (cone_count != 0) {
        ...
        const div7Item7 = document.createElement("div");
        ...
        const div7Qty7 = document.createElement("div");
        div7Qty7.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive ; border: none;background : transparent";
        const div7QtyText = document.createTextNode(`${cone_count}`);
        div7.appendChild(div7Qty7);
        div7Qty7.appendChild(div7QtyText);

        const div7Price7 = document.createElement("div");
      ...
      if (creamBar_count != 0) {
        ...
        const div8Item8 = document.createElement("div");
        ...
        const div8Qty8 = document.createElement("div");
        div8Qty8.style.cssText = "text-align: center ; font-size: 20px; font-weight : 200px ; font- family: cursive ; border: none;background : transparent";
        const div8QtyText = document.createTextNode(`${creamBar_count}`);
        div8.appendChild(div8Qty8);
        div8Qty8.appendChild(div8QtyText);

        const div8Price8 = document.createElement("div");
