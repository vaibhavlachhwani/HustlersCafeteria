...
homefinal.addEventListener('click', () => {
    window.location.href = "https://parthsharma4010.github.io/AboutUs-HackTheChain-/";
});

const fix = document.querySelector("#contact")
fix.addEventListener('click', () => {
    window.location.href = "https://parthsharma4010.github.io/Contact-HackTheChain-/";
}); 
